...
function Tickets() {
  return (
    <div className="Tickets">
      ...
      <TicketsLine name="Waiting on Feature Request" number="4238" />
      <hr />
      <TicketsLine name="Awaiting Customer Response" number="1005" />
      <hr />
      <TicketsLine name="Awaiting Developer Fix" number="914" />
      <hr />
